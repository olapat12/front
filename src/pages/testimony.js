...
export default class Testimony extends React.Component{
    ...
    state={ 
        ...
        {
            speech: 'Home care grant USA has allowed me to integrate my work into a sustainability science framework and to participate in Future Earth’s Knowledge-Actions Networks.',
            name: 'DenverFish',
            tt: '20 Dec 2019',
            logo: `${logo}`
        },
